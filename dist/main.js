...
const ui = (0,_ui__WEBPACK_IMPORTED_MODULE_2__.uiController)()
...
// sort db
const q = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.query)(colRef, (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.orderBy)("createdAt", "desc"))
...
editBtn.addEventListener("click", e => {
  e.preventDefault()
  const docRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.doc)(db, "books", e.target.dataset.id)
...
table.addEventListener("click", e => {
  ...
  // toggle red status
    ...
    ;(0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.getDoc)(docRef).then(doc => {
      ...
      if (isRead === "Read") {
        (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.updateDoc)(docRef, { isRead: "Not read" })
      }
      else {
        (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.updateDoc)(docRef, { isRead: "Read" })
      }
    })
  }
})
...
const removeBook = (id) => {
  const docRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_1__.doc)(db, "books", id)
